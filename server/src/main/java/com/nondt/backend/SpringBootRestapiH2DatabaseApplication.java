...
public class SpringBootRestapiH2DatabaseApplication {
    ...
    , MedicineRepository MedicineRepository , TypemedicineRepository typemedicineRepository,WorktimeRepository worktimeRepository, TypepackingRepository typepackingRepository ,RoomRepository roomRepository ) {
        return args -> {
            ...
            Stream.of( "กระปุก","แผง","ซอง","ขวด","เข็ม" ).forEach(typepackings -> {
            ...
            Stream.of( "ห้องผ่าตัด1","ห้องผ่าตัด2","ห้องผ่าตัด 3","ห้องตรวจ 1","ห้องตรวจ 2","ห้องตรวจ 3","ห้องตรวจ 4","ห้องตรวจภายใน","ห้องฉายรังสี",
            "ห้อง CT Scan1","ห้อง CT Scan 2","ห้อง X-ray 1","ห้อง X-ray 2","ห้องกายภาพ","ห้องทดลอง").forEach(rooms -> {
                Room room = new Room();
                room.setRoom(rooms);
